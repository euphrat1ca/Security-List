...
- https://github.com/thehappydinoa/iOSRestrictionBruteForce    基于 Python 实现的 iOS 访问限制密码破解工具
...
- https://github.com/fireeye/PwnAuth    OAuth（开放授权是一个开放标准，允许用户让第三方应用访问该用户在某一网站上存储的私密的资源),平台
...
#### office漏洞利用大全
- http://www.freebuf.com/articles/terminal/150285.html    无需开启宏即可在word文档中利用DDE执行命令
...
- https://github.com/tezukanice/Office8570	利用ppsx幻灯片，http://www.freebuf.com/vuls/144054.html
...
- https://github.com/eladshamir/Internal-Monologue    后渗透攻击工具, 无需LSASS进程Mimikatz是从LSASS进程内存中提取内容, 从内存中提取明文密码, NTLM哈希, Kerberos ticket, 以及执行pass-the-hash/pass-the-ticket攻击等
...
- https://github.com/mdsecactivebreach/CACTUSTORCH    基于DotNetToJScript使用js、vbs执行恶意代码
- https://github.com/mdsecactivebreach/SharpShooter    基于DotNetToJScript使用js、vbs执行恶意代码
#### 后门生成、免杀捆绑
...
- https://github.com/Mr-Un1k0d3r/DKMC    恶意软件免杀工具
...
- https://github.com/trustedsec/social-engineer-toolkit    kali内置的社工工具
...
### 安全相关工具
- https://github.com/Security-Onion-Solutions/security-onion    用于入侵检测，网络安全监控和日志管理。最新版基于Ubuntu 16.04，集成Elastic Stack后采用分布式架构，可以非常方便地打造企业级网络安全监控平台
